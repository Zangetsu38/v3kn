...
int main() {
    ...
    // Migrate users from NPID to account ID
    // migrate_users_npid_to_account_id();
    ...
    // Migrate activiies from NPID to account ID
    // migrate_activities_npid_to_account_id();

    // Migrate friends from NPID to account ID
    // migrate_friends_npid_to_account_id();

    // Migrate friend events from NPID to account ID
    // migrate_friend_events_npid_to_account_id();
